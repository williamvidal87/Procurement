                                ...
                                <table class="table table-striped table-hover table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($insertProcureds as $index => $insertProcured)
                                            <tr>
                                                <td>
                                                    <input class="form-control form-control-sm" type="text"  wire:model="insertProcureds.{{$index}}.item_no" size="1" onkeypress='return event.charCode >= 46 && event.charCode <= 57'>
                                                    @error('insertProcureds'.'.'.$index.'.'.'item_no') <span style="color: red">Required</span> @enderror
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm" type="text"  wire:model="insertProcureds.{{$index}}.unit_measure" size="2">
                                                    @error('insertProcureds'.'.'.$index.'.'.'unit_measure') <span style="color: red">Required</span> @enderror
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm" type="text" wire:model="insertProcureds.{{$index}}.item_description" size="40">
                                                    @error('insertProcureds'.'.'.$index.'.'.'item_description') <span style="color: red">Required</span> @enderror
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm" type="text" wire:model="insertProcureds.{{$index}}.qty" size="1" onkeypress='return event.charCode >= 46 && event.charCode <= 57'>
                                                    @error('insertProcureds'.'.'.$index.'.'.'qty') <span style="color: red">Required</span> @enderror
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm" type="text" wire:model="insertProcureds.{{$index}}.estimated_cost" size="3" onkeypress='return event.charCode >= 46 && event.charCode <= 57'>
                                                ...
                                                <td>
                                                    <button wire:click.prevent="removeItem({{$index}})" class="py-0 btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i>Remove</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
