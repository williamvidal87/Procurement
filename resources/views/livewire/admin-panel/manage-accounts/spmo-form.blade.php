<div>
    <div class="modal-header">
        <h1 class="modal-title" id="exampleModalLabel">SPMO</h1>
        <button class="close" data-dismiss="modal" aria-label="Close" wire:click="closeSpmoForm"><span aria-hidden="true">&times;</span></button>
    </div>
    ...
    <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" wire:click="closeSpmoForm">Close</button>
