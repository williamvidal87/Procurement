...
@push('budgetutilization-table-scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('openBudgetUtilizationModal', () => {
            $('#budgetutilizationModal').modal('show')
        });
        
        window.livewire.on('closeBudgetUtilizationModal', () => {
        ...
        window.livewire.on('openSwalDelete', (UserID) => {
            swal("Are you sure you want to delete this Data?", {
                ...
                if (okay) {
                    ...
                    window.Livewire.emit('refresh_budgetutilization_table')
                }
                });
        });
