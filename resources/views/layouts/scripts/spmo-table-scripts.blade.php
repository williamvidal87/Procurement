...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('openSpmoModal', () => {
            $('#spmoModal').modal('show')
        });
        
        window.livewire.on('closeSpmoModal', () => {
            $('#spmoModal').modal('hide')
        });
        ...
        window.livewire.on('openSwalDelete', (UserID) => {
            swal("Are you sure you want to delete this Data?", {
                ...
                if (okay) {
                    ...
                    window.Livewire.emit('refresh_spmo_table')
                }
                });
        });
